...
enum {
    ...
    TK1_MMIO_WATCHDOG_BASE    = TK1_MMIO_BASE | 0x05000000,
    ...
    TK1_MMIO_WATCHDOG_CTRL       = TK1_MMIO_WATCHDOG_BASE | 0x20,
    TK1_MMIO_WATCHDOG_CTRL_START_BIT = 0,
    TK1_MMIO_WATCHDOG_CTRL_STOP_BIT  = 1,
    TK1_MMIO_WATCHDOG_STATUS     = TK1_MMIO_WATCHDOG_BASE | 0x24,
    TK1_MMIO_WATCHDOG_STATUS_RUNNING_BIT = 0,
    TK1_MMIO_WATCHDOG_TIMER_INIT = TK1_MMIO_WATCHDOG_BASE | 0x28,
    TK1_MMIO_WATCHDOG_CURR_TIMER = TK1_MMIO_WATCHDOG_BASE | 0x2c,
